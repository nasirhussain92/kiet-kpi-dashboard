...
const POSITIONS = [
  { id:"vc",          title:"Vice Chancellor",           short:"VC",          person:"Prof. Dr. Muhammad Khalid Khan",                        campus:"All",    cat:"Senior",   kpis:64, areas:["Academics","Governance","Research & Development","Community Services","Financial Status","Diversity & Inclusion","Graduate Employability","Co-Curricular Activities","Sustainability","Automation Initiatives"] },
  { id:"df",          title:"Director Finance",          short:"DF",          person:"Mr. Ahsan Manzoor",                        campus:"All",    cat:"Senior",   kpis:54, areas:["Financial Governance & Sustainability","Financial Management","Technology Integration","Expenditure Financial Discipline"] },
  { id:"qec",         title:"Director QEC",              short:"QEC",         person:"Prof. Dr. Sajida Parveen",campus:"Both",      cat:"Director", kpis:27, areas:["Status of QEC Office","Functions of QEC","International Ranking","Technology Integration"] },
  { id:"oric",        title:"Director ORIC",             short:"ORIC",        person:"Mr. Mubashar Yousuf",                        campus:"All",      cat:"Director", kpis:30, areas:["Research Support","IP Management","Industry Engagement","Recognition & Awards","Operations & HR","ORIC Steering Committee","Entrepreneurship & Innovation"] },
  { id:"coe",         title:"Controller of Examinations",short:"CoE",         person:"Mr. Shehzad Khan",                        campus:"All",    cat:"Director", kpis:28, areas:["General Administration","Examination Management","Technology Integration"] },
  { id:"reg",         title:"Registrar (Acting)",        short:"Reg",         person:"Prof. Dr. Tariq Jalees",  campus:"All",    cat:"Director", kpis:32, areas:["Administration & Coordination","Admission & Enrollment","Faculty Support","Financial Coordination","Equity & Inclusivity","Discipline & Inquiries","Campus Management & Safety","Transparency & Accountability","Technology Integration"] },
  { id:"dean_cocis",  title:"Dean CoCIS",                short:"Dean CoCIS",  person:"Prof. Dr. Salman Ahmed Khan",                        campus:"NN",      cat:"Dean",     kpis:36, accr:"NCEAC", areas:["Academics","Governance","Research & Development","Community Services","Co-Curricular Activities","Accreditation & QA","Diversity & Inclusion","Graduate Employability","Technology Integration"] },
  ...
  { id:"hod_ms_nn",   title:"HoD Management Sciences",   short:"HoD MS (NN)", person:"Dr. Qurat ul Ain Kazmi",                        campus:"NN",      cat:"HoD",      kpis:33, accr:"NBEAC",    areas:["Academics & Administration","Research & Development","Community Services","Co-Curricular Activities","Diversity & Inclusion","Facilities & Infrastructure","Accreditation & QA","Technology Integration"] },
  { id:"hod_ms_sf",   title:"HoD Management Sciences",   short:"HoD MS (SF)", person:"Dr. Muhammad Asadullah",                        campus:"SF",      cat:"HoD",      kpis:33, accr:"NBEAC",    areas:["Academics & Administration","Research & Development","Community Services","Co-Curricular Activities","Diversity & Inclusion","Facilities & Infrastructure","Accreditation & QA","Technology Integration"] },
  ...
  { id:"hod_cs",      title:"HoD Computer Science",      short:"HoD CS",      person:"Dr. Muhammad Fahad",                        campus:"NN",      cat:"HoD",      kpis:33, accr:"NCEAC",    areas:["Academics & Administration","Research & Development","Community Services","Co-Curricular Activities","Diversity & Inclusion","Facilities & Infrastructure","Accreditation & QA","Technology Integration"] },
  { id:"hod_se",      title:"HoD Software Engineering",  short:"HoD SE",      person:"Dr. Muhammad Ayub Latif",                        campus:"NN",      cat:"HoD",      kpis:33, accr:"NCEAC/PEC",areas:["Academics & Administration","Research & Development","Community Services","Co-Curricular Activities","Diversity & Inclusion","Facilities & Infrastructure","Accreditation & QA","Technology Integration"] },
  { id:"hod_ai",      title:"HoD Artificial Intelligence",short:"HoD AI",     person:"Dr. Sohail Imran",                        campus:"NN",      cat:"HoD",      kpis:33, accr:"NCEAC",    areas:["Academics & Administration","Research & Development","Community Services","Co-Curricular Activities","Diversity & Inclusion","Facilities & Infrastructure","Accreditation & QA","Technology Integration"] },
  { id:"dir_dasr",    title:"Director DASR",             short:"Dir.DASR",    person:"Prof. Dr. Maaz Bin Ahmed",campus:"All",      cat:"Director", kpis:33, dual:true, areas:["Academics & Administration","Research & Development","Community Services","Co-Curricular Activities","Diversity & Inclusion","Facilities & Infrastructure","Accreditation & QA","Technology Integration"] },
];
    ...
    <div style={{minHeight:"100vh",background:"#F3F4F6",fontFamily:"'Segoe UI',system-ui,sans-serif"}}>
      ...
      <div style={{background:BLUE,padding:"16px 24px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
        <div>
          ...
          <div style={{color:"#93C5FD",fontSize:11,marginTop:3}}>SHEC Letter No. AD(QA)/SHEC/01/KPIs-I/2023 · Developed and Managed by: Assistant Registrar Nasir Hussain</div>
        </div>
